    ...
    <AppShell>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold tracking-tight text-foreground">Клиенты</h2>
            <p className="text-muted-foreground">Ваша база постоянных покупателей.</p>
          </div>
        ...
        <div className="relative">
          ...
          <Input className="pl-10" placeholder="Поиск клиента по имени или номеру..." />
        </div>
            ...
            state.clients.map((client) => (
              <Card key={client.id} className="group overflow-hidden transition-all hover:shadow-md">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button variant="outline" className="w-full text-xs font-medium">Посмотреть историю</Button>
                </CardContent>
              </Card>
            ))
          ) : (
